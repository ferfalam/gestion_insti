    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{route('gestion_authClass.dem')}}">
                ...
                <div class="form-row">
                    <div class="col">
                        <div class="form-group"><label for="nom"><strong>Nom</strong></label><input class="form-control" type="text" placeholder="Nom" name="last_name">
                        <span style="color: red">@error('nom') {{$message}}@enderror</span>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group"><label for="prenom"><strong>Prenom</strong></label><input class="form-control" type="text" placeholder="Prenom" name="first_name">
                ...
                <div class="form-row">
                    <div class="col" data-aos="fade-left" data-aos-duration="700" data-aos-delay="600">
                        <div class="form-group"><label for="first_name"><strong>Pièce jointe 1</strong></label><input class="form-control" type="file" placeholder="Piece" name="piece"></div>
                        <span style="color: red">@error('pièce') {{$message}}@enderror</span>
                    </div>
                    <div class="col" data-aos="fade-left" data-aos-duration="700" data-aos-delay="600">
                        <div class="form-group"><label for="first_name"><strong>Pièce jointe 2</strong></label><input class="form-control" type="file" placeholder="Piece" name="piece"></div>
                        <span style="color: red">@error('pièce') {{$message}}@enderror</span>
                    </div>
                    <div class="col" data-aos="fade-left" data-aos-duration="700" data-aos-delay="600">
                        <div class="form-group"><label for="first_name"><strong>Pièce jointe 3</strong></label><input class="form-control" type="file" placeholder="Piece" name="piece"></div>
                        <span style="color: red">@error('pièce') {{$message}}@enderror</span>
                    </div>
                    <div class="col" data-aos="fade-left" data-aos-duration="700" data-aos-delay="600">
                        <div class="form-group"><label for="first_name"><strong>Pièce jointe 4</strong></label><input class="form-control" type="file" placeholder="Piece" name="piece"></div>
                    </div>
                </div>
                <div >
