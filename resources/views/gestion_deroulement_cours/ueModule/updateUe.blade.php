...
@section('title') UE À Mettre À Jour @endsection
...
@section('main')
        ...
        <div class="form-container shadow">
            ...
            <form data-bs-hover-animate="pulse" method="post" action="{{ route('gestion_deroulement_cours.updateUe', ['id' => $flight->id]) }}" novalidate>
                {{ csrf_field() }} 
