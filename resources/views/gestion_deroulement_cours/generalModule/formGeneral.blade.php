...
@section('title') Nouveau Module General @endsection
...
@section('main')
        ...
        <div class="form-container shadow">
            ...
            <form data-bs-hover-animate="pulse" method="post" action="{{ route('gestion_deroulement_cours.saveNewGenerals') }}" novalidate>
                {{ csrf_field() }} 
        ...
        <li class="retourAccueil" > <a href="{{ route('gestion_deroulement_cours.showGenerals') }}" > Afficher tous les Modules Generals </a>  </li>
