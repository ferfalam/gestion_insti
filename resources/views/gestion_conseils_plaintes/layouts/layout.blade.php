...
<body>
    <div id="app">
        <div id="wrapper">
            <nav class="navbar navbar-dark align-items-start sidebar .fixed-left sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        ...
                        <li class="nav-item {{ (request()->is('gestion_conseils_plaintes/convocations*')) ? 'active' : ''}}" role="presentation"><a class="nav-link" href="{{ route('gestion_conseils_plaintes.liste_convocations') }}"><i class="fas fa-list-alt"></i><span><strong>Convocations</strong><br></span></a></li>
