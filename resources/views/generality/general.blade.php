                        ...
                        @foreach($generals as $one_module_general)
                            <div class="row">
                                <ul>
                                    ...
                                    <button class="btn btn-primary"> <a href="{{ route('generalById', ['id'=>$one_module_general->id]) }}"> Mettre à jour </a> </button>
                                    <button class="btn btn-danger"> <a href="{{ route('deleteGeneral', ['id'=>$one_module_general->id]) }}"> Supprimer </a> </button>
                                </ul>
                            </div>
                        @endforeach
